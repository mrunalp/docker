...
func (d *driver) setDockerRootUidGid(container *libcontainer.Config, dockerRootUserName string) error {
	...
	container.UidMappings = []libcontainer.IdMap{
		{0, container.UserNsUid, 1},
		{1, 1, container.UserNsUid - 1},
	}
	container.GidMappings = []libcontainer.IdMap{
